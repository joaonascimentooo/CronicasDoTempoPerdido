    ...
    <div className="w-full min-h-screen">
      <section className="w-full min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center overflow-hidden relative">
        ...
        <Motion defaultStyle={{ opacity: 0 }} style={{ opacity: spring(1, { delay: 1200 }) }}>
          {(style) => (
            <div className="absolute bottom-6 sm:bottom-8 left-1/2 transform -translate-x-1/2" style={{ opacity: style.opacity }}>
              <div className="animate-bounce text-orange-400 text-xl sm:text-2xl">↓</div>
            </div>
          )}
        </Motion>
      </section>
              ...
              >
                {(style) => (
                  ...
                  >
                    ...
                    <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400 mb-3 sm:mb-4">{item.title}</h3>
      ...
      <section className="w-full py-16 sm:py-24 px-4 sm:px-6 bg-slate-800 flex justify-center">
        <div className="w-full max-w-4xl">
          <Motion defaultStyle={{ opacity: 0, y: 40 }} style={{ opacity: spring(1), y: spring(0) }}>
            {(style) => (
              <div style={{ opacity: style.opacity, transform: `translateY(${style.y}px)` }}>
                <h3 className="text-2xl sm:text-4xl md:text-5xl font-black text-white mb-4 sm:mb-6">
